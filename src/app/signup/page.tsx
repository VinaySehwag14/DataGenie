    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
                <div className="max-w-md w-full bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl p-8 text-center shadow-2xl animate-in fade-in zoom-in duration-500">
                    <div className="w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-6 glow-animation">
                        <svg className="w-8 h-8 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                    </div>
                    <h2 className="text-2xl font-bold text-white mb-2">Welcome to DataGenie!</h2>
                    <p className="text-gray-400">Account created successfully. Redirecting you to the dashboard...</p>
                </div>
            </div>
        )
    }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 relative overflow-hidden selection:bg-indigo-500/30">
            ...
            <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-500">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Start analyzing your data with AI power</p>
                </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-400">
                    ...
                    <Link href="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold hover:underline transition-all">
                        Sign in
                    </Link>
                </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-indigo-600 to-pink-600 text-white py-3 rounded-lg font-medium hover:shadow-lg transform hover:-translate-y-0.5 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
